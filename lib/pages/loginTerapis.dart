...
import 'lansia.dart';
import 'mainTherapis.dart';

class LoginTerapis extends StatefulWidget {
  const LoginTerapis({Key? key}) : super(key: key);

  @override
  _LoginTerapisState createState() => _LoginTerapisState();
}

class _LoginTerapisState extends State<LoginTerapis> {
  ...
  Widget build(BuildContext context) {
    ...
    handleSigninButton() async {
      ...
      if (await authProvider.loginDokter(username.text, password.text)) {
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (cootext) => RegisterTerapis()));
              },
              child: Text(
                'Daftar ',
